...
const ArrowTrendingLineIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      {...props}
      fill="currentColor"
...
export default ArrowTrendingLineIcon;

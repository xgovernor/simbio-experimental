...
type BloodCenterTableFilterFormType = {
    firstName: string;
    lastName: string;
    email: string;
    phone: string;
...
const BloodCenterTableFilter = () => {
    const initialValues: BloodCenterTableFilterFormType = {
        firstName: "",
        lastName: "",
        email: "",
        phone: "",
    ...
    const onSubmitHandler = (
        values: BloodCenterTableFilterFormType,
        { setSubmitting }: FormikHelpers<BloodCenterTableFilterFormType>,
    ): void => {
        setSubmitting(true);
...
export default React.memo(BloodCenterTableFilter);

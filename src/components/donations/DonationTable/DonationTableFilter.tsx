...
type DontaionTableFilterFormType = {
    firstName: string;
    lastName: string;
    email: string;
    phone: string;
...
const DontaionTableFilter = () => {
    const initialValues: DontaionTableFilterFormType = {
        firstName: "",
        lastName: "",
        email: "",
        phone: "",
    ...
    const onSubmitHandler = (
        values: DontaionTableFilterFormType,
        { setSubmitting }: FormikHelpers<DontaionTableFilterFormType>,
    ): void => {
        setSubmitting(true);
...
export default React.memo(DontaionTableFilter);

...
const RouteNav = ({ className, ...rest }: RouteNavPropsType) => {
    ...
    return (
        <div className="flex h-[24px] w-[52px] items-center justify-between" {...rest}>
            <div className="flex w-6 items-center justify-start">
                <Button
                    className="hover:opacity-70"
                    icon={<ChevronLeft24Regular primaryFill="#fff" title="Go to previous page" />}
                    onClick={goBack}
            ...
            <div className="flex w-6 items-center justify-end">
                <Button
                    className="hover:opacity-70"
                    icon={<ChevronRight24Regular primaryFill="#fff" title="Go to next page" />}
                    onClick={goForward}

...
const DashboardMenuBar: FC<MenuBarPropsType> = ({ className, ...rest }: MenuBarPropsType) => {
    ...
    return (
        <header className="sticky top-0 z-1 w-full border-b border-b-[#e0e0e0] bg-[#f5f5f5]" ref={menuBarRef} {...rest}>
            <div className="flex h-full w-full flex-row flex-nowrap items-start justify-between px-4 py-2">
                <div className="flex w-full flex-row flex-nowrap items-center justify-start gap-3">
                    ...
                    {showAvatar && <Avatar aria-label="Avatar" image={{ src: "/image/logo/bss.jpg" }} />}

...
const TeamsTable: FC<TeamsTablePropsType> = ({ title, description, data }: TeamsTablePropsType) => {
...
const TableBodyRow: FC<{ classes: any; item: TeamsItemType }> = ({ classes, item }) => {
    return useMemo(
        () => (
            <TableRow key={item._id} className={classes.table_body_row}>
                <TableCell className={mergeClasses(classes.tbc_root, classes.tc_org)}>
                    <TableCellLayout
                        media={
                            <Avatar aria-label={item.title} name={item.title} image={{ src: item.avatar }} size={28} />
                        }
                    >
                ...
                <TableCell className={mergeClasses(classes.tbc_text, classes.tbc_timeline)}>
                    <TableCellLayout>
                        <Text>
                            <Date dateString={item.period_from} /> - <Date dateString={item.period_to} />
                        </Text>
                    </TableCellLayout>
                </TableCell>

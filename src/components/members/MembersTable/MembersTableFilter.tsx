...
type MembersTableFilterFormType = {
  firstName: string;
  lastName: string;
  email: string;
  phone: string;
...
const MembersTableFilter = () => {
  const initialValues: MembersTableFilterFormType = {
    firstName: "",
    lastName: "",
    email: "",
    phone: "",
  ...
  const onSubmitHandler = (
    values: MembersTableFilterFormType,
    { setSubmitting }: FormikHelpers<MembersTableFilterFormType>,
  ): void => {
    setSubmitting(true);
...
export default React.memo(MembersTableFilter);

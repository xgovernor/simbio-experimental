...
type ContactsTableFilterFormType = {
  firstName: string;
  lastName: string;
  email: string;
  phone: string;
...
const ContactsTableFilter = () => {
  const initialValues: ContactsTableFilterFormType = {
    firstName: "",
    lastName: "",
    email: "",
    phone: "",
  ...
  const onSubmitHandler = (
    values: ContactsTableFilterFormType,
    { setSubmitting }: FormikHelpers<ContactsTableFilterFormType>,
  ): void => {
    setSubmitting(true);
...
export default React.memo(ContactsTableFilter);

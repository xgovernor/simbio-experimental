...
const SettingsPrivacy: FC<SettingsPrivacyPropsType> = ({ className }: SettingsPrivacyPropsType) => {
    return (
            ...
            <>
                <section className="mb-6">
                    ...
                    <p className="body1 mb-4">
                        Simbio uses your previous searches to improve search results. You can delete or download your
                        search history any time.
                    </p>

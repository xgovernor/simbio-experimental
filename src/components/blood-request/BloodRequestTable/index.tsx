...
const BloodRequestTable: FC<BloodRequestTablePropsType> = ({
    ...
    return (
        <section className="w-full h-full mt-[22px] pt-0 pe-[22px] pb-[22px] ps-[22px]" {...rest}>
                    ...
                    <CardPreview>
                        <Table className="w-full" sortable noNativeElements={true}>
                            ...
                            <TableBody className="w-full">
                                {data.map((item, index) => (
                                    <TableRow key={index} className="px-[22px] border-b-[rgb(240, 240, 240)]">
                                        ...
                                        <TableCell className="w-full caption1">
                                            <TableCellLayout>
                                                {item?.blood_group && item.blood_group}{" "}
                                                {item?.blood_type && item.blood_type} ({item?.quantity && item.quantity}{" "}
                                                beg)
                                            </TableCellLayout>
                                        </TableCell>
                                        <TableCell className="w-full caption1Strong">

...
const ClubsTableFilter = () => {
  const initialValues: ClubsTableFilterFormType = {
    firstName: "",
    lastName: "",
    email: "",
    phone: "",
  ...
  const onSubmitHandler = (
    values: ClubsTableFilterFormType,
    { setSubmitting }: FormikHelpers<ClubsTableFilterFormType>,
  ): void => {
    setSubmitting(true);
          ...
          {({
            ...
            <Form>
              <DialogBody className="p-0">
                ...
                >
                  <h3 className="subtitle2Stronger">Table filter</h3>
                </DialogTitle>
...
export default React.memo(ClubsTableFilter);

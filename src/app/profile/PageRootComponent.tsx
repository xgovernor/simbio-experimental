...
const PageRootComponent: FC = () => {
    return (
        <DashboardLayout>
            <div className="grid grid-cols-4 gap-22px 2xl:grid-cols-6 p-[22px]">
                {/* Profile Stats */}
                ...
                <div className="rounded bg-white p-5 shadow">
                    <div className="w-full">
                        ...
                        <div className="mt-3">This will display organization information</div>
                    </div>
                </div>
                ...
                <div className="rounded bg-white p-5 shadow">
                    <div className="w-full">
                        ...
                        <div className="mt-3">
                            This card will show the list of accomplishments made by the organization
                        </div>
                    </div>
                </div>
                ...
                <div className="rounded bg-white p-5 shadow">
                    <div className="w-full">
                        ...
                        <div className="mt-3">
                            This card will show the list of campaigns arranged by the organization
                        </div>
                    </div>
                </div>
                ...
                <div className="rounded bg-white p-5 shadow">
                    <div className="w-full">
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                            <div className="rounded-full border px-2.5 py-0.5 text-xs">A+</div>
                            <div className="rounded-full border px-2.5 py-0.5 text-xs">A-</div>
                            <div className="rounded-full border px-2.5 py-0.5 text-xs">B+</div>
                            <div className="rounded-full border px-2.5 py-0.5 text-xs">B-</div>
                            <div className="rounded-full border px-2.5 py-0.5 text-xs">AB+</div>
                            <div className="rounded-full border px-2.5 py-0.5 text-xs">AB-</div>
                            <div className="rounded-full border px-2.5 py-0.5 text-xs">O+</div>
                            <div className="rounded-full border px-2.5 py-0.5 text-xs">O-</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-2 rounded bg-white py-5 shadow">
                    <div className="w-full">
                        <div className="px-5">
                            ...
                            <p className="mt-3">This will show last 10 login information with device, browser and location</p>
                        </div>
                        <DeviceList />
                    </div>
                </div>
                ...
                <div className="rounded bg-white p-5 shadow">
                    <div className="w-full">
                        ...
                        <div className="mt-3">This card will show blood donation requests</div>
                    </div>
                </div>
                ...
                <div className="rounded bg-white p-5 shadow">
                    <div className="w-full">
                        ...
                        <div className="mt-3">List of all the blood donation made my the organization</div>
                    </div>
                </div>

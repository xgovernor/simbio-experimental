  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-center text-xs">
        ...
        beyond. Our overarching objective is to deliver a versatile system that
        caters to the needs of any blood donation organization. What sets this
        system apart is its ability to seamlessly oversee the journey of a donor
        from one corner of the nation to a patient residing in another,
        particularly in special cases, all while enhancing the efficiency of the
        donation process and elevating the donor experience. Our approach to
        security exceeds the standard norms prevalent within the same domain,
        ensuring a robust safeguarding of information. Furthermore, our
        strategic vision encompasses integration with prevalent ERP systems in
        the health sector, elevating its utility and value.
      </p>

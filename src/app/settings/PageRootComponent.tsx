...
const PageRootComponent: FC<PageRootComponentPropsType> = ({ data, page }: PageRootComponentPropsType) => {
    ...
    const TABS: SettingsMenuTabType[] = [
        ...
        },
        {
            ...
            component: <SettingsLanguageAndDate timeFormats={data.timeFormats} dateFormats={data.dateFormats} timeZones={data.timeZones} language={data.language} />,
        },
        {
            id: "appearance",
            name: "Appearance",
    ...
    return (
        <Layout breadcrumb={BREADCRUMB_MENU} title="Settings" icon={<Settings24Regular />}>
            <SettingsLayout tabs={TABS} selectedValue={selectedValue} onTabSelect={onTabSelect}>
